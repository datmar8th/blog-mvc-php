...
*************************************************************/
	...
	$file = "sitemap-byme.xml";

	// Set the start URL. Here is http used, use https:// for 
	// SSL websites.
	$start_url = "https://vieclamdanang.vn/";      
	...
	function GetUrl ($url) {
		$agent = "Mozilla/5.0 (compatible; iProDev PHP XML Sitemap Generator/" . VERSION . ", https://vieclamdanang.vn)";
	...
	copy('sitemap-byme.xml', RootURI.'/sitemap-byme.xml');
